    ...
    <div className="bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 group h-full flex flex-col">
      ...
      <div className="p-4 sm:p-6 flex flex-col flex-grow">
        ...
        <a
          ...
          className="mt-auto flex items-center justify-center gap-2 bg-primary text-white py-2.5 sm:py-3 px-4 sm:px-6 rounded-xl font-bold hover:bg-primary/90 hover:gap-3 transition-all cursor-pointer shadow-lg shadow-primary/20 text-sm sm:text-base"
        >
